...
<body  data-options="fit:true">
    ...
    <!--左侧导航栏使用手风琴菜单-->
     ...
     <!-- 各菜单栏使用linkbutton链接到指定页面 -->
        ...
        <a href="bookInsert.jsp" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新书上架</a><br><br>
        <a href="bookDelete.jsp" class="easyui-linkbutton" data-options="iconCls:'icon-add'">书籍下架</a>
        </div>
    </div>
    </div>
    
    <!--center主功能编辑区-->
    <div data-options="region:'center',title:'最近发货信息'" style="padding:5px;background:#eee;">
    	<!-- 表格类采用DataGrid实现 -->
    	<table class="easyui-datagrid" style="width:400px;height:250px" fit="true" data-options="url:'getAllOrderaction.action',fitColumns:true,singleSelect:true">
		    <thead>
				<tr>
					<th data-options="field:'borderid',width:100">订单号</th>
					<th data-options="field:'sid',width:100">学生学号</th>
					<th data-options="field:'bid',width:100">图书号</th>
					<th data-options="field:'bnum',width:100">数量</th>
					<th data-options="field:'btprice',width:100">总价</th>
