...
<body  data-options="fit:true">
    ...
    <!--center主功能编辑区-->
    <div data-options="region:'center',title:'新增图书'" style="padding:5px;background:#eee;">
    	<form id="chgInfoForm" action="bookinsaction.action" method="post">
			<!-- 使用table做页面布局管理 -->
			<table align="center">
				<tr>
					<td>
						<!-- 使用table做页面布局管理 -->
						<table align="center">
							<tr><td>图书名：</td><td><input class="easyui-validatebox" name="book.Bname"></td><td></td></tr>
							<tr><td>作者：</td><td><input class="easyui-validatebox" name="book.Bauthor"></td><td></td></tr>
							<tr><td>出版社：</td><td><input class="easyui-validatebox" name="book.Bphouse"></td><td></td></tr>
							<tr><td>单价：</td><td><input class="easyui-validatebox" name="book.Buprice"></td><td></td></tr>
					</td>
				</tr>
				<tr>
					<td align="left"><button type="submit" class="easyui-linkbutton" data-options="iconCls:'icon-save'">添加</button></td>
