...
<body  data-options="fit:true">
    ...
    <!--center主功能编辑区-->
    <div data-options="region:'center',title:'图书下架'" style="padding:5px;background:#eee;">
	   	<form id="chgInfoForm" action="bookdelaction.action" method="post">
				<!-- 使用table做页面布局管理 -->
				<table align="center">
					<tr>
						<td>
							<!-- 使用table做页面布局管理 -->
							<table align="center">
								<tr><td>图书号：</td><td><input class="easyui-validatebox" name="book.Bid"></td><td></td></tr>
						</td>
					</tr>
					<tr>
						<td align="left"><button type="submit" class="easyui-linkbutton" data-options="iconCls:'icon-save'">删除</button></td>
